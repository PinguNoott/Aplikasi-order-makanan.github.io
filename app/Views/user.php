    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
             ...
             <a href="<?= base_url('home/tambahuser') ?>" class="btn btn-primary">Tambah User</a>
    ...
    <tbody>
      <?php $no = 1; foreach ($satu as $dua): ?>
        <tr>
          ...
          <td><?= $dua->foto ?></td>
          <td class="actions">
           <a href="<?= base_url('home/edituser/' . $dua->id_user) ?>" class="btn-edit">Edit</a>
            <a href="<?= base_url('home/hapus_user/'.$dua->id_user) ?>" class="btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
