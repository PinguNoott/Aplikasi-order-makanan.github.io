...
.item {
    flex: 1 1 calc(33.333% - 20px); /* Responsive columns with spacing */
    max-width: calc(33.333% - 20px);
    box-sizing: border-box;
    padding: 10px;
}
...
.card {
    ...
    max-width: 300px; /* Set a max width to prevent cards from becoming too wide */
    margin: 0 auto; /* Center the card if necessary */
}

.card-img-slider {
    width: 100%;
    height: 210px; /* Adjust to fit your design */
...
.card-container {
    display: flex;
    justify-content: center; /* Center cards if you have multiple in a row */
...
<body>
        ...
        <div class="row">
            <div class="col-12 sspemesanan">
                <?php foreach ($satu as $key) { ?>
                    <div class="item">
                        <div class="card">
                        <?php if (!empty($key->foto2)): ?>
        <div class="card-img-slider">
            <img src="<?=base_url('photo barang/'.$key->foto)?>" alt="Card image cap">
            <img src="<?=base_url('photo barang/'.$key->foto2)?>" alt="Card image cap">
        </div>
    <?php else: ?>
        <img class="card-img-top" src="<?=base_url('photo barang/'.$key->foto)?>" alt="Card image cap">
    <?php endif; ?>
                            <div class="card-body">
    ...
    <div id="itemModal" class="modal">
        <div class="modal-content">
            ...
            <button class="payment-btn">Bayar</button>
        </div>
    </div>
